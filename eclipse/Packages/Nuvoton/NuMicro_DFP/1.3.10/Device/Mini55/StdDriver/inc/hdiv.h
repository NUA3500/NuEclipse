 ...
 * @brief    MINI55 series HDIV driver header file
 *
 * @note
...
/** @addtogroup MINI55_HDIV_Driver HDIV Driver
  @{
*/


/** @addtogroup MINI55_HDIV_EXPORTED_FUNCTIONS HDIV Exported Functions
  @{
*/
...
/*@}*/ /* end of group MINI55_HDIV_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_HDIV_Driver */
