 ...
 * @brief    MINI55 series TIMER driver header file
 *
 * @note
...
/** @addtogroup MINI55_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup MINI55_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
#define TIMER_CAPTURE_TRIGGER_COUNTING_MODE (TIMER_EXTCTL_CAPMODE_Msk)     /*!< Trigger counting mode */
...
#define TIMER_TOGGLE_TXEX                   (TIMER_CTL_TGLPINSEL_Msk)     /*!< Timer use TxEX, x = 0, 1 pin as toggle output pin */

/*@}*/ /* end of group MINI55_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup MINI55_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group MINI55_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_TIMER_Driver */
