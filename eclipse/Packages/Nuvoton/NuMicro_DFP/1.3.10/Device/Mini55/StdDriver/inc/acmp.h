 ...
 * @version  V1.00
 * $Revision: 4 $
 * $Date: 15/07/03 11:24a $
 * @brief    MINI55 series Analog Comparator(ACMP) driver header file
 *
 * @note
...
/** @addtogroup MINI55_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/
...
#define ACMP_HYSTERESIS_ENABLE_15mv    (1UL << ACMP_CTL_HYSSEL_Pos)    ///< Enable hysteresis function \hideinitializer
#define ACMP_HYSTERESIS_ENABLE_90mv    (2UL << ACMP_CTL_HYSSEL_Pos)    ///< Enable hysteresis function \hideinitializer
...
/*@}*/ /* end of group MINI55_ACMP_EXPORTED_CONSTANTS */
