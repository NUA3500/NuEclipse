 ...
 * $Revision: 11 $
 * $Date: 15/07/07 6:26p $
 * @brief    MINI55 series PWM driver header file
 *
 * @note
...
/** @addtogroup MINI55_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup MINI55_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group MINI55_PWM_EXPORTED_CONSTANTS */


/** @addtogroup MINI55_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
...
/*@}*/ /* end of group MINI55_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_PWM_Driver */
