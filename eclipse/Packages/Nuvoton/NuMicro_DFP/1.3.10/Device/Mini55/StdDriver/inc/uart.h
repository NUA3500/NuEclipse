 ...
 * $Revision: 8 $
 * $Date: 15/07/08 3:47p $
 * @brief    MINI55 series UART driver header file
 *
 * @note
...
/** @addtogroup MINI55_UART_Driver UART Driver
  @{
*/

/** @addtogroup MINI55_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group MINI55_UART_EXPORTED_CONSTANTS */


/** @addtogroup MINI55_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
...
/*@}*/ /* end of group MINI55_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_UART_Driver */
