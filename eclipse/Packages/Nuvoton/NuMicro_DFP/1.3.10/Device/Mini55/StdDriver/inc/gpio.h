 ...
 * $Revision: 11 $
 * $Date: 15/07/09 9:40a $
 * @brief    MINI55 series GPIO driver header file
 *
 * @note
...
/** @addtogroup MINI55_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup MINI55_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group MINI55_GPIO_EXPORTED_CONSTANTS */

/** @addtogroup MINI55_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
...
/*@}*/ /* end of group MINI55_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_GPIO_Driver */
