 ...
 * $Revision: 7 $
 * $Date: 15/12/31 1:07p $
 * @brief    MINI55 series I2C driver header file
 *
 * @note
...
/** @addtogroup MINI55_I2C_Driver I2C Driver
  @{
*/


/** @addtogroup MINI55_I2C_EXPORTED_CONSTANTS I2C Exported Constants
  @{
*/
...
/*@}*/ /* end of group MINI55_I2C_EXPORTED_CONSTANTS */


/** @addtogroup MINI55_I2C_EXPORTED_FUNCTIONS I2C Exported Functions
  @{
*/
...
/**
  ...
  * @return none
  */
#define  I2C_DISABLE_FIFO(i2c) ( (i2c)->CTL1 &= ~I2C_CTL1_FIFOEN_Msk )
...
/**
  ...
  * @return none
  */
#define I2C_ENABLE_FIFO(i2c) ( (i2c)->CTL1 |= I2C_CTL1_FIFOEN_Msk )
...
/*@}*/ /* end of group MINI55_I2C_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group MINI55_I2C_Driver */
