 ...
 * $Revision: 6 $
 * $Date: 17/05/04 5:16p $
 * @brief    NM1120 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NM1120 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
/**
  * \page pg1 NuMicro NM1120 Series BSP Directory Structure
  * Please refer to Readme.pdf under BSP root directory for the BSP directory structure
  *
  * \page pg2 Revision History
  * Please refer to NuMicro NM1120 Series CMSIS BSP Revision History.pdf under BSP\\Document directory for the BSP Revision History
  *  
*/
...
#include "system_NM1120Series.h"        /* NM1120 System                                          */
 ...
 * |        |          |The NuMicroTM NM1120 series supports word program only. ISPADR[1:0] must be kept 00 for ISP operation.
 * @var FMC_T::ISPDAT
