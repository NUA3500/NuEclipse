...
/**
  * @brief      Set PCLK clock divider
  * @param[in]  u32PclkDiv is PCLK clock divider. Including :
  ...
  *             - \ref CLK_PCLKDIV_APB1DIV_DIV32
  * @return     None
  * @details    This function set PCLK clock divider.
  */
#define CLK_SET_PCLK_DIVIDER(u32PclkDiv)   (CLK->PCLKDIV |= (u32PclkDiv))
