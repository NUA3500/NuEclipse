/**************************************************************************//**
 * @file     usbd.h
 * @brief    M4521 USB driver header file
 * @version  2.0.0
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M4521 supports 8 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M4521 supports 8 endpoint ID. This parameter could be 0 ~ 7.
  *
