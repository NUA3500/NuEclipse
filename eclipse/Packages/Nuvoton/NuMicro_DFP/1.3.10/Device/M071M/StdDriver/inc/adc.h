 ...
 * @file     adc.h
 * @version  V3.00
 * @brief    M071M Series ADC Driver Header File
 *
 * @note
...
/** @addtogroup Device_Driver M071M Device Driver
  @{
*/
...
/**
  ...
  * @note M071M series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
