/**************************************************************************//**
 * @file     NM1200_NM1100.h
 * @version  V1.00
 * $Revision: 5 $
 * $Date: 15/04/15 9:35a $
 * @brief    NM1200_NM1100 peripheral access layer header file.
 *           This file contains all the peripheral register's definitions,
 *           bits definitions and memory mapping for NuMicro NM1200_NM1100 MCU.
 *
 * @note
 * Copyright (C) 2015 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
/**
   \mainpage NuMicro NM1200_NM1100 Driver Reference Guide
   *
   * <b>Introduction</b>
   *
   * This user manual describes the usage of NM1200_NM1100 MCU device driver
   *
   * <b>Disclaimer</b>
   *
   ...
   */
/**
  * \page pg1 NuMicro NM1200_NM1100 BSP Directory Structure
...
#ifndef __NM1200_NM1100_H__
#define __NM1200_NM1100_H__

#ifdef __cplusplus
extern "C" {
#endif

/** @addtogroup NM1200_NM1100_Definitions NM1200_NM1100 Definitions
  This file defines all structures and symbols for NM1200_NM1100:
    - interrupt numbers
...
/******************************************************************************/
/** @addtogroup NM1200_NM1100_CMSIS Device CMSIS Definitions
...
typedef enum IRQn {
    ...
    /******  NM1200_NM1100 specific Interrupt Numbers ***********************************************/
...
/*@}*/ /* end of group NM1200_NM1100_CMSIS */


#include "core_cm0.h"                       /* Cortex-M0 processor and core peripherals           */
#include "system_NM1200_NM1100.h"            /* NM1200_NM1100 System include file                  */
#include <stdint.h>

/******************************************************************************/
/*                Device Specific Peripheral registers structures             */
/******************************************************************************/
/** @addtogroup NM1200_NM1100_Peripherals NM1200_NM1100 Peripherals
  NM1200_NM1100 Device Specific Peripheral registers structures
  @{
*/
...
typedef struct {
    ...
    */
     ...
     * |        |          |NM1200_NM1100 supports word program only. ISPADR[1:0] must be kept 00 for ISP operation.
    */
...
#define GP_MODE_MODE6_Pos                (12)                                              /*!< GPIO_T::MODE: MODE6 Position                */
#define GP_MODE_MODE6_Msk                (0x3ul << GP_MODE_MODE6_Pos)                      /*!< GPIO_T::MODE: MODE6 Mask                    */

#define GP_MODE_MODE7_Pos                (14)                                              /*!< GPIO_T::MODE: MODE7 Position                */
#define GP_MODE_MODE7_Msk                (0x3ul << GP_MODE_MODE7_Pos)                      /*!< GPIO_T::MODE: MODE7 Mask                    */

#define GP_DINOFF_DINOFF_Pos             (16)                                              /*!< GPIO_T::DINOFF: DINOFF Position             */
#define GP_DINOFF_DINOFF_Msk             (0xfful << GP_DINOFF_DINOFF_Pos)                  /*!< GPIO_T::DINOFF: DINOFF Mask                 */

#define GP_DOUT_DOUT_Pos                 (0)                                               /*!< GPIO_T::DOUT: DOUT Position                 */
#define GP_DOUT_DOUT_Msk                 (0xfful << GP_DOUT_DOUT_Pos)                      /*!< GPIO_T::DOUT: DOUT Mask                     */

#define GP_DATMSK_DATMSK_Pos             (0)                                               /*!< GPIO_T::DATMSK: DATMSK Position             */
#define GP_DATMSK_DATMSK_Msk             (0xfful << GP_DATMSK_DATMSK_Pos)                  /*!< GPIO_T::DATMSK: DATMSK Mask                 */

#define GP_PIN_PIN_Pos                   (0)                                               /*!< GPIO_T::PIN: PIN Position                   */
#define GP_PIN_PIN_Msk                   (0xfful << GP_PIN_PIN_Pos)                        /*!< GPIO_T::PIN: PIN Mask                       */

#define GP_DBEN_DBEN_Pos                 (0)                                               /*!< GPIO_T::DBEN: DBEN Position                 */
#define GP_DBEN_DBEN_Msk                 (0xfful << GP_DBEN_DBEN_Pos)                      /*!< GPIO_T::DBEN: DBEN Mask                     */

#define GP_INTTYPE_INTTYPE_Pos           (0)                                               /*!< GPIO_T::INTTYPE: INTTYPE Position           */
#define GP_INTTYPE_INTTYPE_Msk           (0xfful << GP_INTTYPE_INTTYPE_Pos)                /*!< GPIO_T::INTTYPE: INTTYPE Mask               */

#define GP_INTEN_FLIEN_Pos               (0)                                               /*!< GPIO_T::INTEN: FLIEN Position               */
#define GP_INTEN_FLIEN_Msk               (0x1ul << GP_INTEN_FLIEN_Pos)                     /*!< GPIO_T::INTEN: FLIEN Mask                   */

#define GP_INTEN_RHIEN_Pos               (16)                                              /*!< GPIO_T::INTEN: RHIEN Position               */
#define GP_INTEN_RHIEN_Msk               (0xfful << GP_INTEN_RHIEN_Pos)                    /*!< GPIO_T::INTEN: RHIEN Mask                   */

#define GP_INTSRC_INTSRC_Pos             (0)                                               /*!< GPIO_T::INTSRC: INTSRC Position             */
#define GP_INTSRC_INTSRC_Msk             (0xfful << GP_INTSRC_INTSRC_Pos)                  /*!< GPIO_T::INTSRC: INTSRC Mask                 */

#define GP_DBNCECON_DBCLKSEL_Pos         (0)                                               /*!< GPIO_DB_T::DBNCECON: DBCLKSEL Position         */
#define GP_DBNCECON_DBCLKSEL_Msk         (0xful << GP_DBNCECON_DBCLKSEL_Pos)               /*!< GPIO_DB_T::DBNCECON: DBCLKSEL Mask             */

#define GP_DBNCECON_DBCLKSRC_Pos         (4)                                               /*!< GPIO_DB_T::DBNCECON: DBCLKSRC Position         */
#define GP_DBNCECON_DBCLKSRC_Msk         (0x1ul << GP_DBNCECON_DBCLKSRC_Pos)               /*!< GPIO_DB_T::DBNCECON: DBCLKSRC Mask             */

#define GP_DBNCECON_ICLKON_Pos           (5)                                               /*!< GPIO_DB_T::DBNCECON: ICLKON Position           */
#define GP_DBNCECON_ICLKON_Msk           (0x1ul << GP_DBNCECON_ICLKON_Pos)                 /*!< GPIO_DB_T::DBNCECON: ICLKON Mask               */
...
#define PWM_CMPDAT0_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT0: CMPD Position             */
#define PWM_CMPDAT0_CMPD_Msk             (0xfffful << PWM_CMPDAT0_CMPD_Pos)                /*!< PWM_T::CMPDAT0: CMPD Mask                 */
...
#define PWM_CMPDAT1_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT1: CMPD Position             */
#define PWM_CMPDAT1_CMPD_Msk             (0xfffful << PWM_CMPDAT1_CMPD_Pos)                /*!< PWM_T::CMPDAT1: CMPD Mask                 */
...
#define PWM_CMPDAT2_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT2: CMPD Position             */
#define PWM_CMPDAT2_CMPD_Msk             (0xfffful << PWM_CMPDAT2_CMPD_Pos)                /*!< PWM_T::CMPDAT2: CMPD Mask                 */
...
#define PWM_CMPDAT3_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT3: CMPD Position             */
#define PWM_CMPDAT3_CMPD_Msk             (0xfffful << PWM_CMPDAT3_CMPD_Pos)                /*!< PWM_T::CMPDAT3: CMPD Mask                 */
...
#define PWM_CMPDAT4_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT4: CMPD Position             */
#define PWM_CMPDAT4_CMPD_Msk             (0xfffful << PWM_CMPDAT4_CMPD_Pos)                /*!< PWM_T::CMPDAT4: CMPD Mask                 */
...
#define PWM_CMPDAT5_CMPD_Pos             (16)                                              /*!< PWM_T::CMPDAT5: CMPD Position             */
#define PWM_CMPDAT5_CMPD_Msk             (0xfffful << PWM_CMPDAT5_CMPD_Pos)                /*!< PWM_T::CMPDAT5: CMPD Mask                 */
...
typedef struct {
    ...
    */
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[23:0]  |CAPDAT    |Timer Continuous Capture Data Register 0~2
...
#define TIMER_CCAPCTL_CCAPEN_Pos           (0)                                               /*!< TIMER_T::CCAPCTL: CCAPEN Position           */
#define TIMER_CCAPCTL_CCAPEN_Msk           (0x1ul << TIMER_CCAPCTL_CCAPEN_Pos)               /*!< TIMER_T::CCAPCTL: CCAPEN Mask               */

#define TIMER_CCAPCTL_INV_Pos              (1)                                               /*!< TIMER_T::CCAPCTL: INV Position              */
#define TIMER_CCAPCTL_INV_Msk              (0x1ul << TIMER_CCAPCTL_INV_Pos)                  /*!< TIMER_T::CCAPCTL: INV Mask                  */

#define TIMER_CCAPCTL_TMRSEL_Pos           (2)                                               /*!< TIMER_AC_T::CCAPCTL: TMRSEL Position           */
#define TIMER_CCAPCTL_TMRSEL_Msk           (0x1ul << TIMER_CCAPCTL_TMRSEL_Pos)               /*!< TIMER_AC_T::CCAPCTL: TMRSEL Mask               */
...
/** @addtogroup NM1200_NM1100_PERIPHERAL_MEM_MAP NM1200_NM1100 Peripheral Memory Map
  Memory Mapped Structure for NM1200_NM1100 Peripheral
  @{
 */
...
/*@}*/ /* end of group NM1200_NM1100_PERIPHERAL_MEM_MAP */


/** @addtogroup NM1200_NM1100_PERIPHERAL_DECLARATION NM1200_NM1100 Peripheral Declaration
  The Declaration of NM1200_NM1100 Peripheral
  @{
 */
...
/*@}*/ /* end of group NM1200_NM1100_PERIPHERAL_DECLARATION */
/*@}*/ /* end of group NM1200_NM1100_Peripherals */

/** @addtogroup NM1200_NM1100_IO_ROUTINE NM1200_NM1100 I/O Routines
  The Declaration of NM1200_NM1100 I/O Routines
  @{
 */
...
/*@}*/ /* end of group NM1200_NM1100_IO_ROUTINE */

/******************************************************************************/
/*                Legacy Constants                                            */
/******************************************************************************/
/** @addtogroup NM1200_NM1100_legacy_Constants NM1200_NM1100 Legacy Constants
  NM1200_NM1100 Legacy Constants
  @{
*/
...
/*@}*/ /* end of group NM1200_NM1100_legacy_Constants */

/*@}*/ /* end of group NM1200_NM1100_Definitions */
