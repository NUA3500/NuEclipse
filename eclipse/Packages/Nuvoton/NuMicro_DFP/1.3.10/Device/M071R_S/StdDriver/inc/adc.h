 ...
 * $Revision: 4 $
 * $Date: 15/05/06 4:49p $
 * @brief    M071R_M071S Series ADC Driver Header File
 *
 * @note
...
/**
  ...
  * @note M071R_M071S series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
