 ...
 * @file     SYS.h
 * @version  V3.0
 * @brief    M479 Series SYS Driver Header File
 *
...
Example 1: If user want to set PA.0 as UART0_RXD in initial function,
...
#define SYS_GPA_MFPH_PA8MFP_OPA2_P            (0x01UL<<SYS_GPA_MFPH_PA8MFP_Pos)  /*!< Operational amplifier 2 positive input pin. \hideinitializer */
...
#define SYS_GPA_MFPH_PA9MFP_OPA2_N            (0x01UL<<SYS_GPA_MFPH_PA9MFP_Pos)  /*!< Operational amplifier 2 negative input pin. \hideinitializer */
...
#define SYS_GPA_MFPH_PA10MFP_OPA2_O           (0x01UL<<SYS_GPA_MFPH_PA10MFP_Pos) /*!< Operational amplifier 2 output pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB0MFP_OPA1_P            (0x01UL<<SYS_GPB_MFPL_PB0MFP_Pos)  /*!< Operational amplifier 1 positive input pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB1MFP_OPA1_N            (0x01UL<<SYS_GPB_MFPL_PB1MFP_Pos)  /*!< Operational amplifier 1 negative input pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB2MFP_OPA1_O            (0x01UL<<SYS_GPB_MFPL_PB2MFP_Pos)  /*!< Operational amplifier 1 output pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB4MFP_OPA0_P            (0x01UL<<SYS_GPB_MFPL_PB4MFP_Pos)  /*!< Operational amplifier 0 positive input pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB5MFP_OPA0_N            (0x01UL<<SYS_GPB_MFPL_PB5MFP_Pos)  /*!< Operational amplifier 0 negative input pin. \hideinitializer */
...
#define SYS_GPB_MFPL_PB6MFP_OPA0_O            (0x01UL<<SYS_GPB_MFPL_PB6MFP_Pos)  /*!< Operational amplifier 0 output pin. \hideinitializer */
...
#define SYS_GPC_MFPL_PC0MFP_OPA3_O            (0x01UL<<SYS_GPC_MFPL_PC0MFP_Pos)  /*!< Operational amplifier 3 output pin. \hideinitializer */
...
#define SYS_GPC_MFPL_PC1MFP_OPA3_N            (0x01UL<<SYS_GPC_MFPL_PC1MFP_Pos)  /*!< Operational amplifier 3 negative input pin. \hideinitializer */
...
#define SYS_GPC_MFPL_PC2MFP_OPA3_P            (0x01UL<<SYS_GPC_MFPL_PC2MFP_Pos)  /*!< Operational amplifier 3 positive input pin. \hideinitializer */
