...
#define TK_CAP_BANK_POL_SEL_GND             (0UL << TK_POLC_POL_CAP_Pos)  /*!< Touch key capacitor bank polarity is GND */
#define TK_CAP_BANK_POL_SEL_AVCCH           (1UL << TK_POLC_POL_CAP_Pos)  /*!< Touch key capacitor bank polarity is AVCCH */
#define TK_CAP_BANK_POL_SEL_VDD             (2UL << TK_POLC_POL_CAP_Pos)  /*!< Touch key capacitor bank polarity is VDD */
 ...
 * \hideinitializer
 */
#define TK_ENABLE_SCAN_KEY(u32Mask) (TK->SCANC |= (u32Mask))
 ...
 * \hideinitializer
 */
#define TK_DISABLE_SCAN_KEY(u32Mask) (TK->SCANC &= ~(u32Mask))
 ...
 * \hideinitializer
 */
#define TK_ENABLE_REF_KEY(u32Mask) (TK->REFC |= (u32Mask))
 ...
 * \hideinitializer
 */
#define TK_DISABLE_REF_KEY(u32Mask) (TK->REFC &= ~(u32Mask))
 ...
 * \hideinitializer
 */
#define TK_GET_COMP_CAP_BANK_DATA(u32TKNum) (((*(__IO uint32_t *) (&(TK->CCBD0) + ((u32TKNum) >> 2))) >> ((u32TKNum) % 4 * 8) & TK_CCBD0_CCBD0_Msk))
