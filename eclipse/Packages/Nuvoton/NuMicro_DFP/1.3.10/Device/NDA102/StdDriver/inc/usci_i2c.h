 ...
 * $Revision: 1 $
 * $Date: 17/04/19 7:48p $
 * @brief    Mini57 Series USCI I2C(UI2C) driver header file
 *
 * @note
...
/** @addtogroup Mini57_USCI_I2C_Driver UI2C Driver (USCI I2C Mode Driver)
  @{
*/

/** @addtogroup Mini57_USCI_I2C_EXPORTED_CONSTANTS UI2C Exported Constants
  @{
*/
...
/*@}*/ /* end of group Mini57_USCI_I2C_EXPORTED_CONSTANTS */
...
/*@}*/ /* end of group Mini57_USCI_I2C_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group Mini57_USCI_I2C_Driver */
