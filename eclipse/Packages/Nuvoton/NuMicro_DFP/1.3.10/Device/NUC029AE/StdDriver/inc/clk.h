 ...
 * @version  V1.00
 * $Revision: 2 $
 * $Date: 14/06/10 10:14a $
 * @brief    NUC029FAE CLK driver header file
 *
 * @note
...
/** @addtogroup NUC029FAE_CLK_Driver CLK Driver
  @{
*/



/** @addtogroup NUC029FAE_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029FAE_CLK_EXPORTED_CONSTANTS */


/** @addtogroup NUC029FAE_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029FAE_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029FAE_CLK_Driver */
