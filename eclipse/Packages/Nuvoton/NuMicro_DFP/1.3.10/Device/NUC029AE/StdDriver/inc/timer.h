 ...
 * @brief    NUC029FAE TIMER driver header file
 *
 * @note
...
/** @addtogroup NUC029FAE_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029FAE_TIMER_EXPORTED_CONSTANTS */
