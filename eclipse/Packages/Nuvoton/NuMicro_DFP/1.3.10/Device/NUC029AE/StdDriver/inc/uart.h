 ...
 * @brief    NUC029FAE UART driver header file
 *
 * @note
...
/** @addtogroup NUC029FAE_UART_Driver UART Driver
  @{
*/

/** @addtogroup NUC029FAE_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define UART_RTS_IS_HIGH_LEV_TRG    (0x1 << UART_MCR_LEV_RTS_Pos) /*!< Set RTS is High Level Trigger   */
#define UART_RTS_IS_LOW_LEV_TRG     (0x0 << UART_MCR_LEV_RTS_Pos) /*!< Set RTS is Low Level Trigger    */
...
/*@}*/ /* end of group NUC029FAE_UART_EXPORTED_CONSTANTS */


/** @addtogroup NUC029FAE_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029FAE_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC029FAE_UART_Driver */
