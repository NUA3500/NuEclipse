 ...
 * $Revision: 6 $
 * $Date: 17/05/04 5:16p $
 * @brief    NM1240 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NM1240 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
/**
  * \page pg1 NuMicro NM1240 Series BSP Directory Structure
  * Please refer to Readme.pdf under BSP root directory for the BSP directory structure
  *
  * \page pg2 Revision History
  * Please refer to NuMicro NM1240 Series CMSIS BSP Revision History.pdf under BSP\\Document directory for the BSP Revision History
  *  
*/
...
#include "system_NM1240Series.h"        /* NM1240 System                                          */
 ...
 * |        |          |The NuMicroTM NM1240 series supports word program only. ISPADR[1:0] must be kept 00 for ISP operation.
 * @var FMC_T::ISPDAT
