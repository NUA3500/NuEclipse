 ...
 * @version  V3.00
 * $Revision: 3 $
 * $Date: 16/06/23 11:12a $
 * @brief    M0564 series PWM driver header file
 *
 * @note
...
#define PWM_SSCTL_SSRC_PWM1                      (1UL<<PWM_SSCTL_SSRC_Pos)    /*!< Synchronous start source comes from PWM0 */
