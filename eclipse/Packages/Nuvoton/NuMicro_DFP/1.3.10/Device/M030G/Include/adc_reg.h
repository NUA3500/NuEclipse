...
typedef struct
{
     ...
     * |[24]    |PWURDY    |ADC Power-up Sequence Completed and Ready for Conversion (Read Only)
...
#define ADC_ADSR0_PWURDY_Pos            (24)                                        /*!< ADC_T::ADSR0: PWURDY Position          */
#define ADC_ADSR0_PWURDY_Msk            (0x1ul << ADC_ADSR0_PWURDY_Pos)             /*!< ADC_T::ADSR0: PWURDY Mask              */
