...
typedef struct
{
     ...
     * |        |          |Note1: Refer to Figure 6.11-13 and Figure 6.11-14 for UART function mode.
     * |        |          |Note2: Refer to Figure 6.11-24 and Figure 6.11-25 for RS-485 function mode.
     ...
     * |        |          |When the using level of TX FIFO Buffer equal to 1, the TXFULL bit is set to 1
     ...
     * |        |          |The detail description is shown in Table 6.11-4.
