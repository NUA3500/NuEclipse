 ...
 * $Revision: 3 $
 * $Date: 20/06/09 9:43a $
 * @brief    M030G Series Timer Controller (TIMER) Driver Header File
 *
 * @note
...
#define TIMER_CAPSRC_INTERNAL                   (1UL << TIMER_CTL_CAPSRC_Pos)      /*!< Capture source from Internal event  \hideinitializer */
...
#define TIMER_TRG_TO_DAC                        (TIMER_CTL_TRGDAC_Msk)             /*!< Timer trigger DAC   \hideinitializer */
