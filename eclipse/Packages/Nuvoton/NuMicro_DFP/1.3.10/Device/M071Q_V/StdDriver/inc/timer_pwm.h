 ...
 * $Revision: 9 $
 * $Date: 16/10/25 4:25p $
 * @brief    M071Q_M071V series Timer PWM Controller(Timer PWM) driver header file
 *
 * @note
...
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_TRIGGER_ADC_AT_ZERO_POINT                      (0UL)     /*!< Timer PWM trigger ADC while counter zero point event occurred */
#define TPWM_TRIGGER_ADC_AT_PERIOD_POINT                    (1UL)     /*!< Timer PWM trigger ADC while counter period point event occurred */
#define TPWM_TRIGGER_ADC_AT_ZERO_OR_PERIOD_POINT            (2UL)     /*!< Timer PWM trigger ADC while counter zero or period point event occurred */
#define TPWM_TRIGGER_ADC_AT_COMPARE_UP_COUNT_POINT          (3UL)     /*!< Timer PWM trigger ADC while counter up count compare point event occurred */
#define TPWM_TRIGGER_ADC_AT_COMPARE_DOWN_COUNT_POINT        (4UL)     /*!< Timer PWM trigger ADC while counter down count compare point event occurred */
...
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_COUNTER_CLKSRC_TMR_CLK             (0UL)    /*!< Timer PWM Clock source selects to TMR_CLK \hideinitializer */
#define TPWM_COUNTER_CLKSRC_TIMER0_INT          (1UL)    /*!< Timer PWM Clock source selects to TIMER0 interrupt event \hideinitializer */
#define TPWM_COUNTER_CLKSRC_TIMER1_INT          (2UL)    /*!< Timer PWM Clock source selects to TIMER1 interrupt event \hideinitializer */
#define TPWM_COUNTER_CLKSRC_TIMER2_INT          (3UL)    /*!< Timer PWM Clock source selects to TIMER2 interrupt event \hideinitializer */
#define TPWM_COUNTER_CLKSRC_TIMER3_INT          (4UL)    /*!< Timer PWM Clock source selects to TIMER3 interrupt event \hideinitializer */

/*---------------------------------------------------------------------------------------------------------*/
/*  Counter Synchronous Mode Constant Definitions                                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_COUNTER_SYNC_DISABLE               (0UL)    /*!< Disable TIMER PWM synchronous function \hideinitializer */
#define TPWM_COUNTER_SYNC_START_BY_TIMER0       ((0<<TIMER_PWMSCTL_SYNCSRC_Pos) | (1<<TIMER_PWMSCTL_SYNCMODE_Pos))  /*!< PWM counter synchronous start by TIMER0 PWM \hideinitializer */
#define TPWM_COUNTER_SYNC_CLEAR_BY_TIMER0       ((0<<TIMER_PWMSCTL_SYNCSRC_Pos) | (3<<TIMER_PWMSCTL_SYNCMODE_Pos))  /*!< PWM counter synchronous clear by TIMER0 PWM \hideinitializer */
#define TPWM_COUNTER_SYNC_START_BY_TIMER2       ((1<<TIMER_PWMSCTL_SYNCSRC_Pos) | (1<<TIMER_PWMSCTL_SYNCMODE_Pos))  /*!< PWM counter synchronous start by TIMER2 PWM \hideinitializer */
#define TPWM_COUNTER_SYNC_CLEAR_BY_TIMER2       ((1<<TIMER_PWMSCTL_SYNCSRC_Pos) | (3<<TIMER_PWMSCTL_SYNCMODE_Pos))  /*!< PWM counter synchronous clear by TIMER2 PWM \hideinitializer */
...
/**
  ...
  * @note       All registers about time counter function will be cleard to 0 and timer clock source will be changed to PCLKx automatically after executing this macro.
  */
...
/**
  ...
  * @note       All registers about PWM counter function will be cleard to 0 after executing this macro.
  */
...
/**
  ...
  *
  * @details    Get the prescaler settng, the target counter clock divider is (CLKPSC + 1).
  */
...
/**
  ...
  *                         - \ref TPWM_COUNTER_SYNC_DISABLE
  *                         - \ref TPWM_COUNTER_SYNC_START_BY_TIMER0
  *                         - \ref TPWM_COUNTER_SYNC_CLEAR_BY_TIMER0
  *                         - \ref TPWM_COUNTER_SYNC_START_BY_TIMER2
  *                         - \ref TPWM_COUNTER_SYNC_CLEAR_BY_TIMER2
  *
  * @return     None
  *
...
/**
  ...
  */
#define TPWM_GET_TRG_ADC_STATUS(timer)          (((timer)->PWMSTATUS & TIMER_PWMSTATUS_ADCTRGF_Msk)? 1 : 0)
...
/**
  ...
  */
#define TPWM_CLEAR_TRG_ADC_STATUS(timer)        ((timer)->PWMSTATUS = TIMER_PWMSTATUS_ADCTRGF_Msk)
...
/**
  ...
  * @note       The defailt brake pin detection is high level or from low to high.
  */
