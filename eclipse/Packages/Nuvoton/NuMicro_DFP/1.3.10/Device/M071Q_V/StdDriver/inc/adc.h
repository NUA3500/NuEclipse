/**************************************************************************//**
 * @file     adc.h
 * @brief    M071Q_M071V series ADC driver header file
 *
 * @note
...
/**
  ...
  * @param[in] u32ChNum ADC Channel, valid value are from 0 to 19 and 29 to 31.
  * @return  16-bit data.
...
/**
  ...
  *                     - \ref ADC_CMP1_INT         :Comparator 1 interrupt flag.
  * @return  None
  * @details ADF (ADSR[0])/CMPF0 (ADSR[1])/CMPF2 (ADSR[2]) can be cleared by writing 1 to itself.
  */
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @param[in] u32ChNum ADC Channel, valid value are from 0 to 7 and 29 to 31.
...
/**
  ...
  * @param[in] adc The pointer of the specified ADC module.
  * @param[in] u32ChNum  Specifies the source channel, valid value are from 0 to 7 and 29 to 31.
