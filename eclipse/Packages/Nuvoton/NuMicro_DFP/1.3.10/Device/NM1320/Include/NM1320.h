 ...
 * $Revision: 39 $
 * $Date: 15/03/03 1:30p $
 * @brief    NM1320 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NM1320 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_NM1320.h"               /* NM1320 System                                           */
...
typedef struct
{
     ...
     * |        |          |NuMicro NM1320 series has a maximum of 17Kx32(68KB) embedded Flash, which supports word program only.
...
/** @addtogroup GPIO General purpose I/O (GPIO)
  Memory Mapped Structure for NM1320 Series General Purpose I/O
  @{
 */
typedef struct
{
