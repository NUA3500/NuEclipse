 ...
 * |        |          |The CRPT_AES_GCM_IVCNT0 keeps the   low weightbyte count of initial vector (i.e., len(IV)[34:3])of AES GCM mode   and can be read and written.
 ...
 * |        |          |The bit   length of IV is 64 bits for AES GCM mode
 * |        |          |The CRPT_AES_GCM_IVCNT1 keeps the   high weightbyte count of initial vector (i.e., len(IV)[64:35])of AES GCM mode   and can be read and written.
 ...
 * |        |          |The CRPT_AES_GCM_ACNT0 keeps the low   weightbyte count of theadditional authenticated data (i.e., len(A)[34:3])of   AES GCM mode and can be read and written.
 * @var CRPT_T::AES_GCM_ACNT1
 * Offset: 0x8C  AES GCM A Byte Count Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[28:0]  |CNT       |AES GCM aByte   Count
 * |        |          |The bit   length of A is 64 bits for AES GCM mode
 * |        |          |The CRPT_AES_GCM_ACNT0 keeps the high   weightbyte count of theadditional authenticated data (i.e., len(A)[63:35])of   AES GCM mode and can be read and written.
 ...
 * |        |          |Note: This bit is always 0 when itu2019s read back.
 ...
 * |        |          |This bit is always 0 when itu2019s read back. Must be written again once START is triggered.
 ...
 * Offset: 0x358  SHA/HMAC Output Feedback Data 0After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * Offset: 0x35C  SHA/HMAC Output Feedback Data 1After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x360  SHA/HMAC Output Feedback Data 2After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x364  SHA/HMAC Output Feedback Data 3After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x368  SHA/HMAC Output Feedback Data 4After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x36C  SHA/HMAC Output Feedback Data 5After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x370  SHA/HMAC Output Feedback Data 6After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x374  SHA/HMAC Output Feedback Data 7After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x378  SHA/HMAC Output Feedback Data 8After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x37C  SHA/HMAC Output Feedback Data 9After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x380  SHA/HMAC Output Feedback Data 10After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x384  SHA/HMAC Output Feedback Data 11After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x388  SHA/HMAC Output Feedback Data 12After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x38C  SHA/HMAC Output Feedback Data 13After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x390  SHA/HMAC Output Feedback Data 14After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x394  SHA/HMAC Output Feedback Data 15After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3A4  SHA/HMAC Output Feedback Data 19After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3AC  SHA/HMAC Output Feedback Data21After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3C4  SHA/HMAC Output Feedback Data 27After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3CC  SHA/HMAC Output Feedback Data 29After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3DC  SHA/HMAC Output Feedback Data 33After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x3EC  SHA/HMAC Output Feedback Data 37After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x404  SHA/HMAC Output Feedback Data 43After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x40C  SHA/HMAC Output Feedback Data 45After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x41C  SHA/HMAC Output Feedback Data 49After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * Offset: 0x42C  SHA/HMAC Output Feedback Data 53After SHA/HMAC Operation
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |FDBCK     |SHA/HMAC Feedback Information
 ...
 * |        |          |This bit is always 0 when itu2019s read back.
 ...
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_10
 * Offset: 0xA28  ECC the Scalar SCALARK Word10of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_11
 * Offset: 0xA2C  ECC the Scalar SCALARK Word11of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_12
 * Offset: 0xA30  ECC the Scalar SCALARK Word12of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_13
 * Offset: 0xA34  ECC the Scalar SCALARK Word13of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_14
 * Offset: 0xA38  ECC the Scalar SCALARK Word14of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_15
 * Offset: 0xA3C  ECC the Scalar SCALARK Word15of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_16
 * Offset: 0xA40  ECC the Scalar SCALARK Word16of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * @var CRPT_T::ECC_K_17
 * Offset: 0xA44  ECC the Scalar SCALARK Word17of Point Multiplication
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
