...
typedef struct
{
     ...
     * |        |          |Note: This bit is only used when DYNCOMPEN(RTC_CLKFMT[16]) is enabled.
     * @var RTC_T::TIME
     ...
     * |[16]    |DYNCOMPEN |Dynamic Compensation Enable Bit
     ...
     * |        |          |0 = Clock source from 32 kHz crystal or external XI_32K input .
     * |        |          |1 = Clock source from internal low speed RC oscillator (LIRC38K).
     * @var RTC_T::DSTCTL
...
#define RTC_CLKFMT_DYNCOMPEN_Pos         (16)                                              /*!< RTC_T::CLKFMT: DYNCOMPEN Position      */
#define RTC_CLKFMT_DYNCOMPEN_Msk         (0x1ul << RTC_CLKFMT_DYNCOMPEN_Pos)               /*!< RTC_T::CLKFMT: DYNCOMPEN Mask          */
