...
typedef struct
{
     ...
     * |        |          |If the TBINTDIS bit is enabled it will not generates TDIFn(PDMA_TDSTS[5:0]) when PDMA controller finishes transfer task.
     ...
     * |        |          |Note: When PDMA finishes each transfer data, this field will be decrease immediately.
     * @var DSCT_T::SA
...
typedef struct
{
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |CHENn     |PDMA Channel Enable Bits
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |PAUSEn    |PDMA Channel n Transfer Pause Control (Write Only)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |SWREQn    |PDMA Software Request (Write Only)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |REQSTSn   |PDMA Channel Request Status (Read Only)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |FPRISETn  |PDMA Fixed Priority Setting
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |FPRICLRn  |PDMA Fixed Priority Clear Bits (Write Only)
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |INTENn    |PDMA Interrupt Enable Bits
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |ABTIFn    |PDMA Read/Write Target Abort Interrupt Status Flag
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |ALIGNn    |Transfer Alignment Flag
     * |        |          |0 = PDMA channel source address and destination address both follow transfer width setting.
     * |        |          |1 = PDMA channel source address or destination address is not follow transfer width setting.
     * @var PDMA_T::TACTSTS
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[5:0]     |TXACTFn   |Transfer on Active Flag (Read Only)
     ...
     * |        |          |1 = Channel connects to UART0_TX.
     * |        |          |2 = Channel connects to UART0_RX.
     * |        |          |3 = Channel connects to UART1_TX.
     * |        |          |4 = Channel connects to UART1_RX.
     * |        |          |5 = Channel connects to UART2_TX.
     * |        |          |6 = Channel connects to UART2_RX.
     * |        |          |7 = Channel connects to UART3_TX.
     * |        |          |8 = Channel connects to UART3_RX.
     * |        |          |9 = Channel connects to UART4_TX.
     * |        |          |10 = Channel connects to UART4_RX.
     * |        |          |11 = Channel connects to UART5_TX.
     * |        |          |12 = Channel connects to UART5_RX.
     * |        |          |13 = Channel connects to SPI0_TX.
     * |        |          |14 = Channel connects to SPI0_RX.
     * |        |          |15 = Channel connects to SPI1_TX.
     * |        |          |16 = Channel connects to SPI1_RX.
     * |        |          |17 = Channel connects to EPWM0_P1_RX.
     * |        |          |18 = Channel connects to EPWM0_P2_RX.
     * |        |          |19 = Channel connects to EPWM0_P3_RX.
     * |        |          |20 = Channel connects to EPWM1_P1_RX.
     * |        |          |21 = Channel connects to EPWM1_P2_RX.
     * |        |          |22 = Channel connects to EPWM1_P3_RX.
     * |        |          |23 = Channel connects to I2C0_TX.
     * |        |          |24 = Channel connects to I2C0_RX.
     * |        |          |25 = Channel connects to I2C1_TX.
     * |        |          |26 = Channel connects to I2C1_RX.
     * |        |          |27 = Channel connects to TMR0.
     * |        |          |28 = Channel connects to TMR1.
     * |        |          |29 = Channel connects to TMR2.
     * |        |          |30 = Channel connects to TMR3.
     * |        |          |31 = Channel connects to EADC0_RX.
     * |        |          |32 = Channel connects to DAC0_TX.
     * |        |          |33 = Channel connects to EPWM0_CH0_TX.
     * |        |          |34 = Channel connects to EPWM0_CH1_TX.
     * |        |          |35 = Channel connects to EPWM0_CH2_TX.
     * |        |          |36 = Channel connects to EPWM0_CH3_TX.
     * |        |          |37 = Channel connects to EPWM0_CH4_TX.
     * |        |          |38 = Channel connects to EPWM0_CH5_TX.
     * |        |          |39 = Channel connects to EPWM1_CH0_TX.
     * |        |          |40 = Channel connects to EPWM1_CH1_TX.
     * |        |          |41 = Channel connects to EPWM1_CH2_TX.
     * |        |          |42 = Channel connects to EPWM1_CH3_TX.
     * |        |          |43 = Channel connects to EPWM1_CH4_TX.
     * |        |          |44 = Channel connects to EPWM1_CH5_TX.
     * |        |          |45 = Channel connects to ACMP0.
     * |        |          |46 = Channel connects to ACMP1.
     * |        |          |Others = Reserved.
     ...
     * |        |          |Please refer to the explanation of REQSRC0.
     */
    DSCT_T        DSCT[6];               /*!< [0x0000 ~ 0x005C] Control Register of PDMA Channel 0 ~ 5                  */
    __I  uint32_t RESERVE0[40];
    __I  uint32_t CURSCAT[6];            /*!< [0x0100 ~ 0x114] Current Scatter-gather Descriptor Table Address of PDMA Channel n */
    __I  uint32_t RESERVE1[186];
    ...
    __IO uint32_t REQSEL4_5;             /*!< [0x0484] PDMA Request Source Select Register 1                            */
} PDMA_T;
...
#define PDMA_CHCTL_CHENn_Msk            (0x3ful << PDMA_CHCTL_CHENn_Pos)                 /*!< PDMA_T::CHCTL: CHENn Mask             */

#define PDMA_PAUSE_PAUSEn_Pos           (0)                                              /*!< PDMA_T::PAUSE: PAUSEn Position        */
#define PDMA_PAUSE_PAUSEn_Msk           (0x3ful << PDMA_PAUSE_PAUSEn_Pos)                /*!< PDMA_T::PAUSE: PAUSEn Mask            */

#define PDMA_SWREQ_SWREQn_Pos           (0)                                              /*!< PDMA_T::SWREQ: SWREQn Position        */
#define PDMA_SWREQ_SWREQn_Msk           (0x3ful << PDMA_SWREQ_SWREQn_Pos)                /*!< PDMA_T::SWREQ: SWREQn Mask            */

#define PDMA_TRGSTS_REQSTSn_Pos         (0)                                              /*!< PDMA_T::TRGSTS: REQSTSn Position      */
#define PDMA_TRGSTS_REQSTSn_Msk         (0x3ful << PDMA_TRGSTS_REQSTSn_Pos)              /*!< PDMA_T::TRGSTS: REQSTSn Mask          */

#define PDMA_PRISET_FPRISETn_Pos        (0)                                              /*!< PDMA_T::PRISET: FPRISETn Position     */
#define PDMA_PRISET_FPRISETn_Msk        (0x3ful << PDMA_PRISET_FPRISETn_Pos)             /*!< PDMA_T::PRISET: FPRISETn Mask         */

#define PDMA_PRICLR_FPRICLRn_Pos        (0)                                              /*!< PDMA_T::PRICLR: FPRICLRn Position     */
#define PDMA_PRICLR_FPRICLRn_Msk        (0x3ful << PDMA_PRICLR_FPRICLRn_Pos)             /*!< PDMA_T::PRICLR: FPRICLRn Mask         */

#define PDMA_INTEN_INTENn_Pos           (0)                                              /*!< PDMA_T::INTEN: INTENn Position        */
#define PDMA_INTEN_INTENn_Msk           (0x3ful << PDMA_INTEN_INTENn_Pos)                /*!< PDMA_T::INTEN: INTENn Mask            */
...
#define PDMA_ALIGN_ALIGNn_Msk           (0x3ful << PDMA_ALIGN_ALIGNn_Pos)                /*!< PDMA_T::ALIGN: ALIGNn Mask            */

#define PDMA_TACTSTS_TXACTFn_Pos        (0)                                              /*!< PDMA_T::TACTSTS: TXACTFn Position     */
#define PDMA_TACTSTS_TXACTFn_Msk        (0x3ful << PDMA_TACTSTS_TXACTFn_Pos)             /*!< PDMA_T::TACTSTS: TXACTFn Mask         */
...
#define PDMA_CHRST_CHnRST_Msk           (0x3ful << PDMA_CHRST_CHnRST_Pos)                /*!< PDMA_T::CHRST: CHnRST Mask            */
...
#define PDMA_REQSEL4_5_REQSRC4_Pos      (0)                                              /*!< PDMA_T::REQSEL4_5: REQSRC4 Position   */
#define PDMA_REQSEL4_5_REQSRC4_Msk      (0x3ful << PDMA_REQSEL4_5_REQSRC4_Pos)           /*!< PDMA_T::REQSEL4_5: REQSRC4 Mask       */

#define PDMA_REQSEL4_5_REQSRC5_Pos      (8)                                              /*!< PDMA_T::REQSEL4_5: REQSRC5 Position   */
#define PDMA_REQSEL4_5_REQSRC5_Msk      (0x3ful << PDMA_REQSEL4_5_REQSRC5_Pos)           /*!< PDMA_T::REQSEL4_5: REQSRC5 Mask       */
/**@}*/ /* PDMA_CONST */
