 ...
 * @file     M471.h
 * @version  V1.00
 * @brief    M471 peripheral access layer header file.
 *           This file contains all the peripheral register's definitions,
 *           bits definitions and memory mapping for NuMicro M471 MCU.
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2017-2019 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
/**
  \mainpage NuMicro M471 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M471 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_M471.h"            /* System include file                         */
#include <stdint.h>
...
#define PRNG_BASE             (APBPERIPH_BASE + 0x7A000UL)
...
#define CIR0_BASE             (APBPERIPH_BASE + 0x1F000UL)
