...
typedef struct
{
     ...
     * |        |          |Note: This bit remains 1 during pending state, when the respective EADC conversion is end, the STPFn (n=0~26) bit is automatically cleared to 0
     * @var EADC_T::OVSTS
     ...
     * @var EADC_T::SCTL
     * Offset: 0x80  EADC Sample Module 0 ~ 3 Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * @var EADC_T::SCTL
     * Offset: 0x90  EADC Sample Module 4 ~ 18 Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4:0]   |CHSEL     |EADC Sample Module Channel Selection
     ...
     * |        |          |Note:When setting this bit field to 1, user must set EADCIENn (EADC_CTL[5:2], n=0~3) = 0 to disable interrupt.
     * @var EADC_T::MCTL1
     * Offset: 0x140  EADC Sample Module 0 ~ 23 Control Register 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |Others = Reserved.
     * @var EADC_T::DAT19
     * Offset: 0x200  EADC Data Register 19 ~ 26 for Sample Module 19 ~ 26
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[15:0]  |RESULT    |EADC Conversion Result
     ...
     * |        |          |1 = Data in RESULT[11:0] bits is valid.
     * @var EADC_T::SCTL19
     * Offset: 0x220  EADC Sample Module 19 ~ 23 Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[4:0]   |CHSEL     |EADC Sample Module Channel Selection
...
#define EADC_CTL1_ULPEN_Pos             (12)                                                /*!< EADC_T::CTL1: ULPEN Position           */
#define EADC_CTL1_ULPEN_Msk             (0x1ul << EADC_CTL1_ULPEN_Pos)                      /*!< EADC_T::CTL1: ULPEN Mask               */

#define EADC_CTL1_ULPDIV_Pos            (13)                                                /*!< EADC_T::CTL1: ULPDIV Position          */
#define EADC_CTL1_ULPDIV_Msk            (0x7ul << EADC_CTL1_ULPDIV_Pos)                     /*!< EADC_T::CTL1: ULPDIV Mask              */

#define EADC_CTL1_DECSET_Pos            (16)                                                /*!< EADC_T::CTL1: DECSET Position          */
#define EADC_CTL1_DECSET_Msk            (0x1ul << EADC_CTL1_DECSET_Pos)                     /*!< EADC_T::CTL1: DECSET Mask              */
...
#define EADC_SCTL16_TRGSEL_Msk          (0x1ful << EADC_SCTL16_TRGSEL_Pos)                  /*!< EADC_T::SCTL16: TRGSEL Mask            */

#define EADC_SCTL16_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL16: EXTREN Position        */
#define EADC_SCTL16_EXTREN_Msk          (0x1ul << EADC_SCTL16_EXTREN_Pos)                   /*!< EADC_T::SCTL16: EXTREN Mask            */

#define EADC_SCTL16_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL16: EXTFEN Position        */
...
#define EADC_SCTL17_TRGSEL_Msk          (0x1ful << EADC_SCTL17_TRGSEL_Pos)                  /*!< EADC_T::SCTL17: TRGSEL Mask            */

#define EADC_SCTL17_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL17: EXTREN Position        */
#define EADC_SCTL17_EXTREN_Msk          (0x1ul << EADC_SCTL17_EXTREN_Pos)                   /*!< EADC_T::SCTL17: EXTREN Mask            */

#define EADC_SCTL17_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL17: EXTFEN Position        */
...
#define EADC_SCTL18_TRGSEL_Msk          (0x1ful << EADC_SCTL18_TRGSEL_Pos)                  /*!< EADC_T::SCTL18: TRGSEL Mask            */

#define EADC_SCTL18_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL18: EXTREN Position        */
#define EADC_SCTL18_EXTREN_Msk          (0x1ul << EADC_SCTL18_EXTREN_Pos)                   /*!< EADC_T::SCTL18: EXTREN Mask            */

#define EADC_SCTL18_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL18: EXTFEN Position        */
...
#define EADC_SCTL19_TRGSEL_Msk          (0x1ful << EADC_SCTL19_TRGSEL_Pos)                  /*!< EADC_T::SCTL19: TRGSEL Mask            */

#define EADC_SCTL19_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL19: EXTREN Position        */
#define EADC_SCTL19_EXTREN_Msk          (0x1ul << EADC_SCTL19_EXTREN_Pos)                   /*!< EADC_T::SCTL19: EXTREN Mask            */

#define EADC_SCTL19_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL19: EXTFEN Position        */
...
#define EADC_SCTL20_TRGSEL_Msk          (0x1ful << EADC_SCTL20_TRGSEL_Pos)                  /*!< EADC_T::SCTL20: TRGSEL Mask            */

#define EADC_SCTL20_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL20: EXTREN Position        */
#define EADC_SCTL20_EXTREN_Msk          (0x1ul << EADC_SCTL20_EXTREN_Pos)                   /*!< EADC_T::SCTL20: EXTREN Mask            */

#define EADC_SCTL20_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL20: EXTFEN Position        */
...
#define EADC_SCTL21_TRGSEL_Msk          (0x1ful << EADC_SCTL21_TRGSEL_Pos)                  /*!< EADC_T::SCTL21: TRGSEL Mask            */

#define EADC_SCTL21_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL21: EXTREN Position        */
#define EADC_SCTL21_EXTREN_Msk          (0x1ul << EADC_SCTL21_EXTREN_Pos)                   /*!< EADC_T::SCTL21: EXTREN Mask            */

#define EADC_SCTL21_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL21: EXTFEN Position        */
...
#define EADC_SCTL22_TRGSEL_Msk          (0x1ful << EADC_SCTL22_TRGSEL_Pos)                  /*!< EADC_T::SCTL22: TRGSEL Mask            */

#define EADC_SCTL22_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL22: EXTREN Position        */
#define EADC_SCTL22_EXTREN_Msk          (0x1ul << EADC_SCTL22_EXTREN_Pos)                   /*!< EADC_T::SCTL22: EXTREN Mask            */

#define EADC_SCTL22_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL22: EXTFEN Position        */
...
#define EADC_SCTL23_TRGSEL_Msk          (0x1ful << EADC_SCTL23_TRGSEL_Pos)                  /*!< EADC_T::SCTL23: TRGSEL Mask            */

#define EADC_SCTL23_EXTREN_Pos          (21)                                                /*!< EADC_T::SCTL23: EXTREN Position        */
#define EADC_SCTL23_EXTREN_Msk          (0x1ul << EADC_SCTL23_EXTREN_Pos)                   /*!< EADC_T::SCTL23: EXTREN Mask            */

#define EADC_SCTL23_EXTFEN_Pos          (22)                                                /*!< EADC_T::SCTL23: EXTFEN Position        */
