...
typedef struct
{
     ...
     * |        |          |00 = ACMPx_N pin.
     * |        |          |01 = Internal comparator reference voltage (CRVx).
     * |        |          |10 = Band-gap voltage.
     * |        |          |11 = DAC0 output.
     ...
     * |        |          |11 = Reserved
     * |        |          |Note: use FCLKDIV must under the condition fo FILTSEL = 3'h7, then set FCLKDIV can get the effect of filtering 128, 256 consecutive PCLKs
     ...
     * |        |          |0 = Calibrating.
     * |        |          |1 = Calibration done.
     * |[1]     |CALNS0    |Comparator0 Calibration Result Status for NMOS
     * |        |          |0 = Pass.
     * |        |          |1 = Fail.
     * |[2]     |CALPS0    |Comparator0 Calibration Result Status for PMOS
     * |        |          |0 = Pass.
     * |        |          |1 = Fail.
     * |[4]     |DONE1     |Comparator1 Calibration Done Status
     * |        |          |0 = Calibrating.
     * |        |          |1 = Calibration done.
     * |[5]     |CALNS1    |Comparator1 Calibration Result Status for NMOS
     * |        |          |0 = Pass.
     * |        |          |1 = Fail.
     * |[6]     |CALPS1    |Comparator1 Calibration Result Status for PMOS
     * |        |          |0 = Pass.
     * |        |          |1 = Fail.
     */
