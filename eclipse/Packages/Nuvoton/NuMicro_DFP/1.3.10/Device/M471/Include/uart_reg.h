...
typedef struct
{
     ...
     * |        |          |Note: This bit is cleared when SLVHDETF(UART_LINSTS[0]), BRKDETF(UART_LINSTS[8]), BITEF(UART_LINSTS[9]), SLVIDPEF (UART_LINSTS[2]) and SLVHEF(UART_LINSTS[1]) all are cleared and software writing u20181u2019 to LINIF(UART_INTSTS[7]).
     ...
     * |        |          |Note2: When transmitter header field (it may be u201Cbreaku201D or u201Cbreak + syncu201D or u201Cbreak + sync + frame IDu201D selected by HSEL (UART_LINCTL[23:22]) field) transfer operation finished, this bit will be cleared automatically.
     ...
     * |        |          |00 = The LIN header includes u201Cbreak fieldu201D.
     * |        |          |01 = The LIN header includes u201Cbreak fieldu201D and u201Csync fieldu201D.
     * |        |          |10 = The LIN header includes u201Cbreak fieldu201D, u201Csync fieldu201D and u201Cframe ID fieldu201D.
     * |        |          |11 = Reserved.
     ...
     * |        |          |The header errors include u201Cbreak delimiter is too short (less than 0.5 bit time)u201D, u201Cframe error in sync field or Identifier fieldu201D, u201Csync field data is not 0x55 in Non-Automatic Resynchronization modeu201D, u201Csync field deviation error with Automatic Resynchronization modeu201D, u201Csync field measure time-out with Automatic Resynchronization modeu201D and u201CLIN header reception time-outu201D.
