 ...
 * $Revision: 4 $
 * $Date: 20/06/11 5:13p $
 * @brief    M471 series Real Time Clock(RTC) driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
#define RTC_CLKSRC_LXT          0x00UL           /*!< Clock Source from LXT \hideinitializer */
#define RTC_CLKSRC_LIRC         0x80UL           /*!< Clock Source from LIRC \hideinitializer */
...
/**
  ...
  * \hideinitializer
  */
#define RTC_CLKSRCSEL(u32ClkSrc)        (RTC->LXTCTL = (RTC->LXTCTL & ~RTC_LXTCTL_RTCCKSEL_Msk) | u32ClkSrc);
