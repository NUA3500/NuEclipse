 ...
 * @file     timer.h
 * @version  V1.00
 * @brief    M471 series Timer Controller(Timer) driver header file
 *
...
#define TIMER_TOUT_PIN_FROM_TX                  (0UL << TIMER_CTL_TGLPINSEL_Pos)   /*!< Timer toggle-output pin is from TMx pin \hideinitializer */
...
#define TIMER_CAPSRC_TX_EXT                     (0UL << TIMER_CTL_CAPSRC_Pos)     /*!< Capture source from TMx_EXT pin      \hideinitializer */
...
#define TIMER_TRG_TO_PWM                        (TIMER_TRGCTL_TRGPWM_Msk)         /*!< Each timer event as EPWM/BPWM counter clock source \hideinitializer */
