 ...
 * @file     uart.h
 * @version  V3.00
 * @brief    M471 series UART driver header file
 *
...
#define UART4_FIFO_SIZE 1ul /*!< UART4 supports separated receive/transmit 1/1 bytes entry FIFO \hideinitializer */
#define UART5_FIFO_SIZE 1ul /*!< UART5 supports separated receive/transmit 1/1 bytes entry FIFO \hideinitializer */
