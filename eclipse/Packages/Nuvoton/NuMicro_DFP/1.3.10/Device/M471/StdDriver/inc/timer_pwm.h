 ...
 * @file     timer_pwm.h
 * @version  V1.01
 * @brief    M471 series Timer PWM Controller(Timer PWM) driver header file
 *
...
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_TOUT_PIN_FROM_TX                   (0UL << TIMER_PWMPOCTL_POSEL_Pos)   /*!< Indicate PWMx output to Tx pins \hideinitializer */
#define TPWM_TOUT_PIN_FROM_TX_EXT               (1UL << TIMER_PWMPOCTL_POSEL_Pos)   /*!< Indicate PWMx output to Tx_ext pins \hideinitializer */
...
/*---------------------------------------------------------------------------------------------------------*/
/*  TPWM Trigger EADC/DAC/PDMA Source Select Constant Definitions                                          */
/*---------------------------------------------------------------------------------------------------------*/
#define TPWM_TRIGGER_AT_PERIOD_POINT            (0UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA while counter period point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_COMPARE_POINT           (1UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA while counter compare point event occurred \hideinitializer */
#define TPWM_TRIGGER_AT_PERIOD_OR_COMPARE_POINT (2UL << TIMER_PWMTRGCTL_TRGSEL_Pos) /*!< Timer PWM trigger EADC/DAC/PDMA while counter period or compare point event occurred \hideinitializer */
...
/**
  ...
  * \hideinitializer
  */
#define TPWM_ENABLE_OUTPUT(timer, u32Channel)   ((timer)->PWMPOCTL = ((timer)->PWMPOCTL & ~(TIMER_PWMPOCTL_POEN_Msk)) | (u32Channel))
...
/**
  ...
  * @retval     1       Specified counter event has trigger EADC start conversion
  *
...
/**
  ...
  * @return     None
  *
  * @details    This macro is used to clear TPWM counter event trigger EADC status.
  * \hideinitializer
  */
...
/**
  ...
  */
#define TPWM_EnableTriggerEADC(timer, u32Condition)  TPWM_EnableTrigger(timer, TIMER_PWMTRGCTL_PWMTRGEADC_Msk, u32Condition)
...
/**
  ...
  */
#define TPWM_DisableTriggerEADC(timer)               TPWM_DisableTrigger(timer, TIMER_PWMTRGCTL_PWMTRGEADC_Msk)
