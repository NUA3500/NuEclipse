 ...
 * @file     bpwm.h
 * @version  V1.00
 * @brief    M471 series PWM driver header file
 *
 * @note
...
#define BPWM_GET_CAPTURE_RISING_DATA(bpwm, u32ChannelNum) (*((__IO uint32_t *) ((((uint32_t)&((bpwm)->RCAPDAT0)) + (u32ChannelNum)*8))))
...
#define BPWM_GET_CAPTURE_FALLING_DATA(bpwm, u32ChannelNum) (*((__IO uint32_t *) ((((uint32_t)&((bpwm)->FCAPDAT0)) + (u32ChannelNum)*8))))
