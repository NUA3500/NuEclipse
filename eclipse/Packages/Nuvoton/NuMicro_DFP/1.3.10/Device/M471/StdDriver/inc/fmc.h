 ...
 * $Revision: 6 $
 * $Date: 20/07/13 3:40p $
 * @brief    M471 Series Flash Memory Controller Driver Header File
 *
...
#define FMC_MULTI_WORD_PROG_LEN 512             /*!< The maximum length of a multi-word program \hideinitializer */
...
#define XOMR2   2UL                             /*!< XOM region 2    \hideinitializer */
#define XOMR3   3UL                             /*!< XOM region 3    \hideinitializer */
/*---------------------------------------------------------------------------------------------------------*/
/*  ISPCTL constant definitions                                                                            */
/*---------------------------------------------------------------------------------------------------------*/
#define IS_BOOT_FROM_LDROM      0x1UL           /*!< ISPCTL setting to select to boot from LDROM \hideinitializer */
#define IS_BOOT_FROM_APROM      0x0UL           /*!< ISPCTL setting to select to boot from APROM \hideinitializer */
...
#define FMC_ISPCMD_MULTI_PROG   0x27UL          /*!< ISP Command: Multuple word program    \hideinitializer */
