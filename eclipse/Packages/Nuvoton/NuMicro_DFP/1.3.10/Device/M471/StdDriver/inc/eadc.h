 ...
 * @file     eadc.h
 * @version  V0.10
 * @brief    M471 series EADC driver header file
 *
...
/**
  ...
  *                          This parameter decides which sample module interrupts will be disabled, valid range are between 1~0x7FFFFFF.
  * @return None
...
/**
  ...
  * \hideinitializer
  */
#define EADC_ENABLE_INT_POSITION(eadc, u32ModuleNum)    (((u32ModuleNum)<=18) ? ((eadc)->SCTL[(u32ModuleNum)] |= EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19] |= EADC_SCTL_INTPOS_Msk))
...
/**
  ...
  * \hideinitializer
  */
#define EADC_DISABLE_INT_POSITION(eadc, u32ModuleNum)   (((u32ModuleNum)<=18) ? ((eadc)->SCTL[(u32ModuleNum)] &= ~EADC_SCTL_INTPOS_Msk) : ((eadc)->SCTL19[(u32ModuleNum)-19] &= ~EADC_SCTL_INTPOS_Msk))
/**
...
/**
  ...
  * @param[in] u32ModuleMask the combination of sample module interrupt status bits. Each bit corresponds to a sample module interrupt status.
  *                          This parameter decides which sample module interrupts will be enabled, valid range are between 1~0x7FFFFFF.
  * @return None
...
/**
  ...
  *                         This parameter decides which sample module will be conversion, valid range are between 1~0x7FFFFFF.
  *                         Bit 0 is sample module 0, bit 1 is sample module 1..., bit 26 is sample module 26.
  * @return None
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module. Each bit corresponds to a sample module.
  *                         This parameter decides which sample module will stop the conversion, valid range are between 1~0x7FFFFFF.
  *                         Bit 0 is sample module 0, bit 1 is sample module 1..., bit 26 is sample module 26.
  * @return None
...
/**
  ...
  * @details This STPFn(EADC_PENDSTS[26:0]) bit remains 1 during pending state, when the respective ADC conversion is end,
...
/**
  ...
  * @details This macro is used to read RESULT bit (EADC_DATn[15:0], n=0~26) field to get conversion data.
  * \hideinitializer
  */
#define EADC_GET_CONV_DATA(eadc, u32ModuleNum)  (((u32ModuleNum)<=18) ? ((eadc)->DAT[(u32ModuleNum)] & EADC_DAT_RESULT_Msk) : ((eadc)->DAT19[(u32ModuleNum)-19] & EADC_DAT_RESULT_Msk))

/**
  * @brief Get the data overrun flag of the user-specified sample module.
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of data overrun status bits. Each bit corresponds to a data overrun status, valid range are between 1~0x7FFFFFF.
  * @return Return the data overrun flag of the user-specified sample module.
  * @details This macro is used to read OV bit (EADC_STATUS0[31:16], EADC_STATUS1[26:16]) field to get data overrun status.
  * \hideinitializer
  */
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of data valid status bits. Each bit corresponds to a data valid status, valid range are between 1~0x7FFFFFF.
  * @return Return the data valid flag of the user-specified sample module.
  * @details This macro is used to read VALID bit (EADC_STATUS0[15:0], EADC_STATUS1[10:0]) field to get data valid status.
  * \hideinitializer
  */
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module overrun status bits. Each bit corresponds to a sample module overrun status, valid range are between 1~0x7FFFFFF.
...
/**
  ...
  *                      Bit 0 is SPOVF0, bit 1 is SPOVF1..., bit 26 is SPOVF26.
  * @return None
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleNum specifies the compare sample module, valid value are from 0 to 26.
