 ...
 * @file     pdma.h
 * @version  V1.00
 * @brief    M471 series PDMA driver header file
 *
...
#define PDMA_UART0_TX         1UL /*!<DMA Connect to UART0_TX \hideinitializer */
#define PDMA_UART0_RX         2UL /*!<DMA Connect to UART0_RX \hideinitializer */
#define PDMA_UART1_TX         3UL /*!<DMA Connect to UART1_TX \hideinitializer */
#define PDMA_UART1_RX         4UL /*!<DMA Connect to UART1_RX \hideinitializer */
#define PDMA_UART2_TX         5UL /*!<DMA Connect to UART2_TX \hideinitializer */
#define PDMA_UART2_RX         6UL /*!<DMA Connect to UART2_RX \hideinitializer */
#define PDMA_UART3_TX         7UL /*!<DMA Connect to UART3_TX \hideinitializer */
#define PDMA_UART3_RX         8UL /*!<DMA Connect to UART3_RX \hideinitializer */
#define PDMA_UART4_TX         9UL /*!<DMA Connect to UART4_TX \hideinitializer */
#define PDMA_UART4_RX        10UL /*!<DMA Connect to UART4_RX \hideinitializer */
#define PDMA_UART5_TX        11UL /*!<DMA Connect to UART5_TX \hideinitializer */
#define PDMA_UART5_RX        12UL /*!<DMA Connect to UART5_RX \hideinitializer */
#define PDMA_SPI0_TX         13UL /*!<DMA Connect to SPI0_TX \hideinitializer */
#define PDMA_SPI0_RX         14UL /*!<DMA Connect to SPI0_RX \hideinitializer */
#define PDMA_SPI1_TX         15UL /*!<DMA Connect to SPI1_TX \hideinitializer */
#define PDMA_SPI1_RX         16UL /*!<DMA Connect to SPI1_RX \hideinitializer */
#define PDMA_EPWM0_P1_RX     17UL /*!<DMA Connect to EPWM0_P1_RX \hideinitializer */
#define PDMA_EPWM0_P2_RX     18UL /*!<DMA Connect to EPWM0_P2_RX \hideinitializer */
#define PDMA_EPWM0_P3_RX     19UL /*!<DMA Connect to EPWM0_P3_RX \hideinitializer */
#define PDMA_EPWM1_P1_RX     20UL /*!<DMA Connect to EPWM1_P1_RX \hideinitializer */
#define PDMA_EPWM1_P2_RX     21UL /*!<DMA Connect to EPWM1_P2_RX \hideinitializer */
#define PDMA_EPWM1_P3_RX     22UL /*!<DMA Connect to EPWM1_P3_RX \hideinitializer */
#define PDMA_I2C0_TX         23UL /*!<DMA Connect to I2C0_TX \hideinitializer */
#define PDMA_I2C0_RX         24UL /*!<DMA Connect to I2C0_RX \hideinitializer */
#define PDMA_I2C1_TX         25UL /*!<DMA Connect to I2C1_TX \hideinitializer */
#define PDMA_I2C1_RX         26UL /*!<DMA Connect to I2C1_RX \hideinitializer */
#define PDMA_TMR0            27UL /*!<DMA Connect to TMR0 \hideinitializer */
#define PDMA_TMR1            28UL /*!<DMA Connect to TMR1 \hideinitializer */
#define PDMA_TMR2            29UL /*!<DMA Connect to TMR2 \hideinitializer */
#define PDMA_TMR3            30UL /*!<DMA Connect to TMR3 \hideinitializer */
#define PDMA_EADC0_RX        31UL /*!<DMA Connect to EADC0_RX \hideinitializer */
#define PDMA_DAC0_TX         32UL /*!<DMA Connect to DAC0_TX \hideinitializer */
#define PDMA_EPWM0_CH0_TX    33UL /*!<DMA Connect to EPWM0_CH0_TX \hideinitializer */
#define PDMA_EPWM0_CH1_TX    34UL /*!<DMA Connect to EPWM0_CH1_TX \hideinitializer */
#define PDMA_EPWM0_CH2_TX    35UL /*!<DMA Connect to EPWM0_CH2_TX \hideinitializer */
#define PDMA_EPWM0_CH3_TX    36UL /*!<DMA Connect to EPWM0_CH3_TX \hideinitializer */
#define PDMA_EPWM0_CH4_TX    37UL /*!<DMA Connect to EPWM0_CH4_TX \hideinitializer */
#define PDMA_EPWM0_CH5_TX    38UL /*!<DMA Connect to EPWM0_CH5_TX \hideinitializer */
#define PDMA_EPWM1_CH0_TX    39UL /*!<DMA Connect to EPWM1_CH0_TX \hideinitializer */
#define PDMA_EPWM1_CH1_TX    40UL /*!<DMA Connect to EPWM1_CH1_TX \hideinitializer */
#define PDMA_EPWM1_CH2_TX    41UL /*!<DMA Connect to EPWM1_CH2_TX \hideinitializer */
#define PDMA_EPWM1_CH3_TX    42UL /*!<DMA Connect to EPWM1_CH3_TX \hideinitializer */
#define PDMA_EPWM1_CH4_TX    43UL /*!<DMA Connect to EPWM1_CH4_TX \hideinitializer */
#define PDMA_EPWM1_CH5_TX    44UL /*!<DMA Connect to EPWM1_CH5_TX \hideinitializer */
#define PDMA_ACMP0           45UL /*!<DMA Connect to ACMP0 \hideinitializer */
#define PDMA_ACMP1           46UL /*!<DMA Connect to ACMP1 \hideinitializer */
