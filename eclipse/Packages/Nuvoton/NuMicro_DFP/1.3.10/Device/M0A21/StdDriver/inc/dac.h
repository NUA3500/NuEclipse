 ...
 * $Revision: 5 $
 * $Date: 20/06/30 5:56p $
 * @brief    M0A21 series DAC driver header file
 *
 * @note
...
/**
  * @brief Enable reference voltage from Vreff.
  * @param[in] dac Base address of DAC module.
  * @return None
  * @details Select reference voltage source from Vreff
  */
#define DAC_VREFFSRC_VREFF(dac) ((dac)->CTL |= DAC_CTL_DACPSEL_Msk)

/**
  * @brief Enable reference voltage from AVDD.
  * @param[in] dac Base address of DAC module.
  * @return None
  * @details Select reference voltage source from AVDD
  */
#define DAC_VREFFSRC_AVDD(dac) ((dac)->CTL &= ~DAC_CTL_DACPSEL_Msk)
...
/**
  ...
  */
#define DAC_ENABLE_OUTPUT(dac) ((dac)->CTL |= DAC_CTL_OUTPUTEN_Msk)
...
/**
  ...
  */
#define DAC_DISABLE_OUTPUT(dac) ((dac)->CTL &= ~DAC_CTL_OUTPUTEN_Msk)

/**
  * @brief Enable the interrupt.
  * @param[in] dac Base address of DAC module.
  * @param[in] u32Ch Not used in M0A21 Series DAC.
  * @return None
