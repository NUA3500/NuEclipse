 ...
 * $Revision: 1 $
 * $Date: 17/04/19 7:48p $
 * @brief    Mini57 Series USCI UART (UUART) driver header file
 *
 * @note
...
/** @addtogroup Mini57_USCI_UART_Driver UUART Driver (USCI UART Mode Driver)
  @{
*/

/** @addtogroup Mini57_USCI_UART_EXPORTED_CONSTANTS UUART Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define UUART_BRK_INT_MASK      (0x001) /*!< LIN break detected interrupt mask */
...
/*@}*/ /* end of group Mini57_USCI_UART_EXPORTED_CONSTANTS */


/** @addtogroup Mini57_USCI_UART_EXPORTED_FUNCTIONS UUART Exported Functions
  @{
*/
...
/*@}*/ /* end of group Mini57_USCI_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group Mini57_USCI_UART_Driver */
