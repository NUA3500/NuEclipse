 ...
 * $Revision: 105 $
 * $Date: 15/07/07 5:00p $
 * @brief    NM1500 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NM1500 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_NM1500.h"        /* NM1500 System                                          */
...
typedef struct
{
     ...
     * |        |          |The NuMicro NM1500 Series has a maximum 32Kx32 (128 KB) of embedded Flash,
