 ...
 * $Revision: 62 $
 * $Date: 15/05/22 9:06a $
 * @brief    NUC029xDE Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of NUC029xDE Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
#include "system_NUC029xDE.h"               /* NUC029xDE System                                           */
...
typedef struct
{
     ...
     * |        |          |NuMicro NUC029xDE series has a maximum of 17Kx32(68KB) embedded Flash, which supports word program only.
...
/** @addtogroup GPIO General purpose I/O (GPIO)
  Memory Mapped Structure for NUC029xDE Series General Purpose I/O
  @{
 */
typedef struct
{
