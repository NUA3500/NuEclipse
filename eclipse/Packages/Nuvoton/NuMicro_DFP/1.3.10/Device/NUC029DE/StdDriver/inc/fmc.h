 ...
 * $Revision: 8 $
 * $Date: 15/05/19 3:41p $
 * @brief    NUC029xDE Series Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup NUC131_FMC_EXPORTED_FUNCTIONS FMC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC131_FMC_EXPORTED_FUNCTIONS */
