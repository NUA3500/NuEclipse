 ...
 * $Revision: 5 $
 * $Date: 15/01/16 1:45p $
 * @brief    NUC029xDE Series ADC Driver Header File
 *
 * @note
...
/**
  ...
  * @note NUC029xDE series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
