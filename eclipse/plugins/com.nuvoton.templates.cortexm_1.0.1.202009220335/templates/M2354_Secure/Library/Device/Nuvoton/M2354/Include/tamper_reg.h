...
typedef struct
{
     ...
     * |        |          |0 = Write 0x5500, the TAMPER coreblock reset will be released.
     * |        |          |1 = Write 0x55AA, the TAMPER coreblock will be reset.
     * |[31]    |TLDORDY   |VDD12_TLDO Power Ready (Read Only)
     * |        |          |0 = The power status of VDD12_TLDO is not ready.
     * |        |          |1 = The power status of VDD12_TLDO is ready.
     * @var TAMPER_T::FUNEN
     ...
     * |        |          |0 = Write 0x30, the HXT detection Disabled.
     * |        |          |1 = Write 0x34, the HXT detection Enabled.
     * |[13:8]  |TMPIOSEL  |Tamper IO Detection Selection Bit
     ...
     * |        |          |The HIRC48M is disable when theses bits equal 0x5A, otherwise it will be enable with any other values.
     * |[24]    |PWRGCHEN0 |Power Glitch Channel 0 Enable
     * |        |          |0 = Power Glitch Channel 0 is Disabled.
     * |        |          |1 = Power Glitch Channel 0 is Enabled.
     * |        |          |Note: To avoid the power noise when the Power Channel is Enabled, it is better to detect the power glitch about 150us after the channel is enabled.
     * |[25]    |PWRGCHEN1 |Power Glitch Channel 1 Enable
     * |        |          |0 = Power Glitch Channel 1 is Disabled.
     * |        |          |1 = Power Glitch Channel 1 is Enabled.
     * |        |          |Note: To avoid the power noise when the Power Channel is Enabled, it is better to detect the power glitch about 150us after the channel is enabled.
     * |[26]    |PWRGCHEN2 |Power Glitch Channel 2 Enable
     * |        |          |0 = Power Glitch Channel 2 is Disabled.
     * |        |          |1 = Power Glitch Channel 2 is Enabled.
     * |        |          |Note: To avoid the power noise when the Power Channel is Enabled, it is better to detect the power glitch about 150us after the channel is enabled.
     * |[27]    |PWRGCHEN3 |Power Glitch Channel 3 Enable
     * |        |          |0 = Power Glitch Channel 3 is Disabled.
     * |        |          |1 = Power Glitch Channel 3 is Enabled.
     * |        |          |Note: To avoid the power noise when the Power Channel is Enabled, it is better to detect the power glitch about 150us after the channel is enabled.
     * @var TAMPER_T::TRIEN
     ...
     * |        |          |Note: The function enable of the over voltage detection is defined in sytem manager.
     * |[9]     |PWRPIEN   |Power Glitch Positive Detection Event Interrupt Enable Bit
     * |        |          |0 = Core Power positive glitch event interrupt Disabled.
     * |        |          |1 = Core Power positive glitch event interrupt Enabled.
     * |[10]    |PWRNIEN   |Power Glitch Negative Detection Event Interrupt Enable Bit
     * |        |          |0 = Core Power negative glitch event interrupt Disabled.
     * |        |          |1 = Core Power negative glitch event interrupt Enabled.
     ...
     * |        |          |0 = RTC Power low voltage detection event interrupt Disabled.
     * |        |          |1 = RTC Power low voltage detection event interrupt Enabled.
     * |[17]    |RTCIOIEN  |RTC Tamper IO Event Interrupt Enable Bit
     ...
     * |[19]    |HXTERRIEN |Core HXT Error Event Interrupt Enable Bit
     * |        |          |0 = Core HXT error event interrupt Disabled.
     * |        |          |1 = Core HXT error event interrupt Enabled.
     ...
     * |        |          |Note 2: LXT detector will automatically disable when Fail/Stop flag rise, resume after Fail/Stop flag clear.
     * |[7]     |CLKSTOPIF |LXT Clock Frequency Monitor Stop Event Interrupt Flag
     * |        |          |0 = LXT frequency is normal.
     * |        |          |1 = LXT frequency is almost stopped.
     * |        |          |Note 1: Write 1 to clear this bit to 0.
     * |        |          |Note 2: LXT detector will automatically disable when Fail/Stop flag rise, resume after Fail/Stop flag clear.
     * |[8]     |OVPOUTIF  |AVDD Over Voltage Event Interrupt Flag
     * |        |          |0 = AVDD no over voltage is detected.
     * |        |          |1 = AVDD over voltage is detected.
     * |        |          |Note: Write 1 to clear this bit.
     * |[9]     |PWRPEVIF  |Power Glitch Positive Detection Interrupt Flag
     * |        |          |0 = Core Power positive glitch is not detected.
     * |        |          |1 = Core Power positive glitch is detected.
     * |        |          |Note: It can be written 1 to clear only (No clear by TCORERST)
     * |[10]    |PWRNEVIF  |Power Glitch Negative Detection Interrupt Flag
     * |        |          |0 = Core Power negative glitch is not detected.
     * |        |          |1 = Core Power negative glitch is detected.
     * |        |          |Note: It can be written 1 to clear only (No clear by TCORERST)
     * |[11]    |ACTSEIF   |Active Shield Event Detection Interrupt Flag
     * |        |          |0 = Active shield event interrupt flag is not detected.
     * |        |          |1 = Active shield event interrupt flag is detected including the VDD12_TLDO and GND attack.
     * |        |          |Note: Write 1 to clear this bit after the all of ACTSTxIF bits have been cleaned.
     ...
     * |        |          |0 = RTC Power low voltage detection event interrupt flag is not detected.
     * |        |          |1 = RTC Power low voltage detection event interrupt flag is detected.
     * |[17]    |RIOTRIGIF |RTC Tamper IO Event Interrupt Flag
     ...
     * |[19]    |HXTERRIF  |Core HXT Error Event Interrupt Flag
     * |        |          |0 = Core HXT no fail event interrupt flag.
     * |        |          |1 = Core HXT fail event interrupt flag.
     * |        |          |Note: Write 1 to clear this bit.
     * |[20]    |VBATLOSSIF|RTC VBAT LOSS Detection Event Interrupt Flag
     * |        |          |0 = RTC VBAT Power loss detection event interrupt flag is not detected.
     * |        |          |1 = RTC VBAT Power loss detection event interrupt flag is detected.
     * |        |          |Note: Write 1 to clear this bit.
     * |[21]    |SECWDTIF  |Security Watch Dog Event Interrupt Flag
     * |        |          |0 = No security WDT event interrupt flag detected.
     * |        |          |1 = Security WDT event interrupt flag is detected.
     * |        |          |Note: Write 1 to clear this bit.
     * |[22]    |TLDOBODIF |Tamper LDO BOD Event Interrupt Flag
     * |        |          |0 = Brown out event interrupt flag no detected.
     ...
     * @var TAMPER_T::TIOCTL
     * Offset: 0x18  TAMPER's Tamper I/O Function Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * Offset: 0x24  TAMPER's Active Shield Tamper I/O Function Control Register 1
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * Offset: 0x28  TAMPER's Active Shield Tamper I/O Function Control Register 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |110 = 216 * TLIRC32K.
     * |        |          |111 = 217 * TLIRC32K.
     * |        |          |Note: After revising this field, setting SEEDRLD2 (TAMPER_ACTSTIOCTL2[4]) can reload change rate immediately.
     ...
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[7:0]   |PWRECNTP  |Positive Power Glitch Error Tolerance
     * |        |          |The value indicates the tolerance count for positive power glitch event.
     ...
     * |[23:16] |PVSPIKECNT|Positive Power Glitch Current Count (Read Only)
     * |        |          |The value indicates the current count for positive power glitch event.
     * |        |          |Note: It can be clear by write 1 on PWRPIEN.
     * |[31:24] |NVPSIKECNT|Negative Power Glitch Current Count (Read Only)
     * |        |          |The value indicates the current count for negative power glitch event.
     * |        |          |Note: It can be clear by write 1 on PWRNIEN.
     * @var TAMPER_T::LDOTRIM
     * Offset: 0x38  TAMPER LDO Trim Value Control Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[3:0]   |TLDOTRIM  |VDD12_TLDO Output Voltage Trim
     * |        |          |The value indicates the trim value of the VDD12_TLDO output voltage.
     * |[9:8]   |TLDOIQSEL |VDD12_TLDO Qu Current Selection
     * |        |          |Indicates the Qu current selection of VDD12_TLDO.
     ...
     * @var TAMPER_T::PWRG2
     * Offset: 0x40  TAMPER Power Glitch Control Register 2
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     ...
     * |        |          |The power level is control in system manager
    ...
    __IO uint32_t PWRG2;                 /*!< [0x0040] TAMPER Power Glitch Control Register 2                           */
...
#define TAMPER_FUNEN_HXTDETEN_Pos        (1)                                               /*!< TAMPER_T::FUNEN: HXTDETEN Position     */
#define TAMPER_FUNEN_HXTDETEN_Msk        (0x1ul << TAMPER_FUNEN_HXTDETEN_Pos)              /*!< TAMPER_T::FUNEN: HXTDETEN Mask         */
...
#define TAMPER_FUNEN_PWRGCHEN0_Pos       (24)                                              /*!< TAMPER_T::FUNEN: PWRGCHEN0 Position    */
#define TAMPER_FUNEN_PWRGCHEN0_Msk       (0x1ul << TAMPER_FUNEN_PWRGCHEN0_Pos)             /*!< TAMPER_T::FUNEN: PWRGCHEN0 Mask        */

#define TAMPER_FUNEN_PWRGCHEN1_Pos       (25)                                              /*!< TAMPER_T::FUNEN: PWRGCHEN1 Position    */
#define TAMPER_FUNEN_PWRGCHEN1_Msk       (0x1ul << TAMPER_FUNEN_PWRGCHEN1_Pos)             /*!< TAMPER_T::FUNEN: PWRGCHEN1 Mask        */

#define TAMPER_FUNEN_PWRGCHEN2_Pos       (26)                                              /*!< TAMPER_T::FUNEN: PWRGCHEN2 Position    */
#define TAMPER_FUNEN_PWRGCHEN2_Msk       (0x1ul << TAMPER_FUNEN_PWRGCHEN2_Pos)             /*!< TAMPER_T::FUNEN: PWRGCHEN2 Mask        */

#define TAMPER_FUNEN_PWRGCHEN3_Pos       (27)                                              /*!< TAMPER_T::FUNEN: PWRGCHEN3 Position    */
#define TAMPER_FUNEN_PWRGCHEN3_Msk       (0x1ul << TAMPER_FUNEN_PWRGCHEN3_Pos)             /*!< TAMPER_T::FUNEN: PWRGCHEN3 Mask        */

#define TAMPER_TRIEN_FMCTRIGEN_Pos       (0)                                               /*!< TAMPER_T::TRIEN: FMCTRIGEN Position    */
#define TAMPER_TRIEN_FMCTRIGEN_Msk       (0x1ul << TAMPER_TRIEN_FMCTRIGEN_Pos)             /*!< TAMPER_T::TRIEN: FMCTRIGEN Mask        */
...
#define TAMPER_INTEN_PWRPIEN_Pos         (9)                                               /*!< TAMPER_T::INTEN: PWRPIEN Position      */
#define TAMPER_INTEN_PWRPIEN_Msk         (0x1ul << TAMPER_INTEN_PWRPIEN_Pos)               /*!< TAMPER_T::INTEN: PWRPIEN Mask          */

#define TAMPER_INTEN_PWRNIEN_Pos         (10)                                              /*!< TAMPER_T::INTEN: PWRNIEN Position      */
#define TAMPER_INTEN_PWRNIEN_Msk         (0x1ul << TAMPER_INTEN_PWRNIEN_Pos)               /*!< TAMPER_T::INTEN: PWRNIEN Mask          */
...
#define TAMPER_INTEN_HXTERRIEN_Pos       (19)                                              /*!< TAMPER_T::INTEN: HXTERRIEN Position    */
#define TAMPER_INTEN_HXTERRIEN_Msk       (0x1ul << TAMPER_INTEN_HXTERRIEN_Pos)             /*!< TAMPER_T::INTEN: HXTERRIEN Mask        */
...
#define TAMPER_INTSTS_PWRPEVIF_Pos       (9)                                               /*!< TAMPER_T::INTSTS: PWRPEVIF Position    */
#define TAMPER_INTSTS_PWRPEVIF_Msk       (0x1ul << TAMPER_INTSTS_PWRPEVIF_Pos)             /*!< TAMPER_T::INTSTS: PWRPEVIF Mask        */

#define TAMPER_INTSTS_PWRNEVIF_Pos       (10)                                              /*!< TAMPER_T::INTSTS: PWRNEVIF Position    */
#define TAMPER_INTSTS_PWRNEVIF_Msk       (0x1ul << TAMPER_INTSTS_PWRNEVIF_Pos)             /*!< TAMPER_T::INTSTS: PWRNEVIF Mask        */
...
#define TAMPER_INTSTS_HXTERRIF_Pos       (19)                                              /*!< TAMPER_T::INTSTS: HXTERRIF Position    */
#define TAMPER_INTSTS_HXTERRIF_Msk       (0x1ul << TAMPER_INTSTS_HXTERRIF_Pos)             /*!< TAMPER_T::INTSTS: HXTERRIF Mask        */
...
#define TAMPER_INTSTS_TLDOBODIF_Pos      (22)                                              /*!< TAMPER_T::INTSTS: TLDOBODIF Position   */
#define TAMPER_INTSTS_TLDOBODIF_Msk      (0x1ul << TAMPER_INTSTS_TLDOBODIF_Pos)            /*!< TAMPER_T::INTSTS: TLDOBODIF Mask       */
...
#define TAMPER_PWRG_PCLKSEL0_Pos         (0)                                               /*!< TAMPER_T::PWRG: PCLKSEL0 Position      */
#define TAMPER_PWRG_PCLKSEL0_Msk         (0xful << TAMPER_PWRG_PCLKSEL0_Pos)               /*!< TAMPER_T::PWRG: PCLKSEL0 Mask          */

#define TAMPER_PWRG_NCLKSEL0_Pos         (4)                                               /*!< TAMPER_T::PWRG: NCLKSEL0 Position      */
#define TAMPER_PWRG_NCLKSEL0_Msk         (0xful << TAMPER_PWRG_NCLKSEL0_Pos)               /*!< TAMPER_T::PWRG: NCLKSEL0 Mask          */

#define TAMPER_PWRG_PDATSEL0_Pos         (8)                                               /*!< TAMPER_T::PWRG: PDATSEL0 Position      */
#define TAMPER_PWRG_PDATSEL0_Msk         (0xful << TAMPER_PWRG_PDATSEL0_Pos)               /*!< TAMPER_T::PWRG: PDATSEL0 Mask          */

#define TAMPER_PWRG_NDATSEL0_Pos         (12)                                              /*!< TAMPER_T::PWRG: NDATSEL0 Position      */
#define TAMPER_PWRG_NDATSEL0_Msk         (0xful << TAMPER_PWRG_NDATSEL0_Pos)               /*!< TAMPER_T::PWRG: NDATSEL0 Mask          */

#define TAMPER_PWRG_PCLKSEL1_Pos         (16)                                              /*!< TAMPER_T::PWRG: PCLKSEL1 Position      */
#define TAMPER_PWRG_PCLKSEL1_Msk         (0xful << TAMPER_PWRG_PCLKSEL1_Pos)               /*!< TAMPER_T::PWRG: PCLKSEL1 Mask          */

#define TAMPER_PWRG_NCLKSEL1_Pos         (20)                                              /*!< TAMPER_T::PWRG: NCLKSEL1 Position      */
#define TAMPER_PWRG_NCLKSEL1_Msk         (0xful << TAMPER_PWRG_NCLKSEL1_Pos)               /*!< TAMPER_T::PWRG: NCLKSEL1 Mask          */

#define TAMPER_PWRG_PDATSEL1_Pos         (24)                                              /*!< TAMPER_T::PWRG: PDATSEL1 Position      */
#define TAMPER_PWRG_PDATSEL1_Msk         (0xful << TAMPER_PWRG_PDATSEL1_Pos)               /*!< TAMPER_T::PWRG: PDATSEL1 Mask          */

#define TAMPER_PWRG_NDATSEL1_Pos         (28)                                              /*!< TAMPER_T::PWRG: NDATSEL1 Position      */
#define TAMPER_PWRG_NDATSEL1_Msk         (0xful << TAMPER_PWRG_NDATSEL1_Pos)               /*!< TAMPER_T::PWRG: NDATSEL1 Mask          */

#define TAMPER_PWRGEV_PWRECNTP_Pos       (0)                                               /*!< TAMPER_T::PWRGEV: PWRECNTP Position    */
#define TAMPER_PWRGEV_PWRECNTP_Msk       (0xfful << TAMPER_PWRGEV_PWRECNTP_Pos)            /*!< TAMPER_T::PWRGEV: PWRECNTP Mask        */

#define TAMPER_PWRGEV_PWRECNTN_Pos       (8)                                               /*!< TAMPER_T::PWRGEV: PWRECNTN Position    */
#define TAMPER_PWRGEV_PWRECNTN_Msk       (0xfful << TAMPER_PWRGEV_PWRECNTN_Pos)            /*!< TAMPER_T::PWRGEV: PWRECNTN Mask        */

#define TAMPER_PWRGEV_PVSPIKECNT_Pos     (16)                                              /*!< TAMPER_T::PWRGEV: PVSPIKECNT Position  */
#define TAMPER_PWRGEV_PVSPIKECNT_Msk     (0xfful << TAMPER_PWRGEV_PVSPIKECNT_Pos)          /*!< TAMPER_T::PWRGEV: PVSPIKECNT Mask      */

#define TAMPER_PWRGEV_NVPSIKECNT_Pos     (24)                                              /*!< TAMPER_T::PWRGEV: NVPSIKECNT Position  */
#define TAMPER_PWRGEV_NVPSIKECNT_Msk     (0xfful << TAMPER_PWRGEV_NVPSIKECNT_Pos)          /*!< TAMPER_T::PWRGEV: NVPSIKECNT Mask      */
...
#define TAMPER_PWRG2_PCLKSEL2_Pos        (0)                                               /*!< TAMPER_T::PWRG2: PCLKSEL2 Position     */
#define TAMPER_PWRG2_PCLKSEL2_Msk        (0xful << TAMPER_PWRG2_PCLKSEL2_Pos)              /*!< TAMPER_T::PWRG2: PCLKSEL2 Mask         */

#define TAMPER_PWRG2_NCLKSEL2_Pos        (4)                                               /*!< TAMPER_T::PWRG2: NCLKSEL2 Position     */
#define TAMPER_PWRG2_NCLKSEL2_Msk        (0xful << TAMPER_PWRG2_NCLKSEL2_Pos)              /*!< TAMPER_T::PWRG2: NCLKSEL2 Mask         */

#define TAMPER_PWRG2_PDATSEL2_Pos        (8)                                               /*!< TAMPER_T::PWRG2: PDATSEL2 Position     */
#define TAMPER_PWRG2_PDATSEL2_Msk        (0xful << TAMPER_PWRG2_PDATSEL2_Pos)              /*!< TAMPER_T::PWRG2: PDATSEL2 Mask         */

#define TAMPER_PWRG2_NDATSEL2_Pos        (12)                                              /*!< TAMPER_T::PWRG2: NDATSEL2 Position     */
#define TAMPER_PWRG2_NDATSEL2_Msk        (0xful << TAMPER_PWRG2_NDATSEL2_Pos)              /*!< TAMPER_T::PWRG2: NDATSEL2 Mask         */

#define TAMPER_PWRG2_PCLKSEL3_Pos        (16)                                              /*!< TAMPER_T::PWRG2: PCLKSEL3 Position     */
#define TAMPER_PWRG2_PCLKSEL3_Msk        (0xful << TAMPER_PWRG2_PCLKSEL3_Pos)              /*!< TAMPER_T::PWRG2: PCLKSEL3 Mask         */

#define TAMPER_PWRG2_NCLKSEL3_Pos        (20)                                              /*!< TAMPER_T::PWRG2: NCLKSEL3 Position     */
#define TAMPER_PWRG2_NCLKSEL3_Msk        (0xful << TAMPER_PWRG2_NCLKSEL3_Pos)              /*!< TAMPER_T::PWRG2: NCLKSEL3 Mask         */

#define TAMPER_PWRG2_PDATSEL3_Pos        (24)                                              /*!< TAMPER_T::PWRG2: PDATSEL3 Position     */
#define TAMPER_PWRG2_PDATSEL3_Msk        (0xful << TAMPER_PWRG2_PDATSEL3_Pos)              /*!< TAMPER_T::PWRG2: PDATSEL3 Mask         */

#define TAMPER_PWRG2_NDATSEL3_Pos        (28)                                              /*!< TAMPER_T::PWRG2: NDATSEL3 Position     */
#define TAMPER_PWRG2_NDATSEL3_Msk        (0xful << TAMPER_PWRG2_NDATSEL3_Pos)              /*!< TAMPER_T::PWRG2: NDATSEL3 Mask         */
