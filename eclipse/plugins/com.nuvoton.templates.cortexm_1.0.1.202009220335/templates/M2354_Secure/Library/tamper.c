...
/**
  ...
  *                                     - \ref TAMPER_INTEN_TAMP0IEN_Msk   : Tamper 0 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_TAMP1IEN_Msk   : Tamper 1 or Pair 0 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_TAMP2IEN_Msk   : Tamper 2 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_TAMP3IEN_Msk   : Tamper 3 or Pair 1 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_TAMP4IEN_Msk   : Tamper 4 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_TAMP5IEN_Msk   : Tamper 5 or Pair 2 Pin Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_CLKFIEN_Msk    : LXT Clock Frequency Monitor Fail interrupt
  *                                     - \ref TAMPER_INTEN_CLKSTOPIEN_Msk : LXT Clock Frequency Monitor Stop interrupt
  *                                     - \ref TAMPER_INTEN_OVPIEN_Msk     : Core_SB Over Voltage Detection interrupt
  *                                     - \ref TAMPER_INTEN_PWRPIEN_Msk    : Core Power Positive Glitch Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_PWRNIEN_Msk    : Core Power Negative Glitch Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_ACTSIEN_Msk    : Active Shiled including VDD, GND and Tamper Pin Event interrupt
  *                                     - \ref TAMPER_INTEN_RTCLVRIEN_Msk  : RTC Low Voltage Detection interrupt
  *                                     - \ref TAMPER_INTEN_RTCIOIEN_Msk   : RTC Tamper I/O Event Detection interrupt
  *                                     - \ref TAMPER_INTEN_RTCLKIEN_Msk   : RTC Clock Monitor Fail or Stop interrupt
  *                                     - \ref TAMPER_INTEN_HXTERRIEN_Msk  : Core HXT Error interrupt
  *                                     - \ref TAMPER_INTEN_VLOSSIEN_Msk   : VBAT Power Loss interrupt
  *                                     - \ref TAMPER_INTEN_WDTIEN_Msk     : Watch Dog Event interrupt
  *                                     - \ref TAMPER_INTEN_BODIEN_Msk     : Brown Out Event interrupt
  *
  * @return     None
  *
