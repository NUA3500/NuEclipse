 ...
 * $Revision: 16 $
 * $Date: 17/01/09 2:30p $
 * @brief    M4521 PDMA driver header file
 *
 * @note
...
/*---------------------------------------------------------------------------------------------------------*/
#define PDMA_SPI0_TX        0x00000001UL            /*!<DMA Connect to SPI0 TX  \hideinitializer */
#define PDMA_SPI1_TX        0x00000002UL            /*!<DMA Connect to SPI1 TX  \hideinitializer */
