 ...
 * @file     M479.h
 * @version  V1.00
 * @brief    M479 peripheral access layer header file.
 *           This file contains all the peripheral register's definitions,
 *           bits definitions and memory mapping for NuMicro M479 MCU.
 *
 * SPDX-License-Identifier: Apache-2.0
 * @copyright (C) 2020 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
/**
  \mainpage NuMicro M479 Driver Reference Guide
  *
  * <b>Introduction</b>
  *
  * This user manual describes the usage of M479 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
typedef enum IRQn
{
    ...
    /******  M479 Specific Interrupt Numbers ********************************************************/
...
#include "system_M479.h"            /* System include file                         */
#include <stdint.h>
